...
class Store(Base):
    ...
    store_short_name: Mapped[str | None] = mapped_column(String(64))
    brand: Mapped[str | None] = mapped_column(String(32))
    store_type: Mapped[str | None] = mapped_column(String(32))
    channel_l1: Mapped[str | None] = mapped_column(String(32))
    channel_l2: Mapped[str | None] = mapped_column(String(32))
    channel_l3: Mapped[str | None] = mapped_column(String(32))
    region: Mapped[str | None] = mapped_column(String(64), index=True)
    sub_region: Mapped[str | None] = mapped_column(String(32))
    province: Mapped[str | None] = mapped_column(String(32))
    city: Mapped[str | None] = mapped_column(String(32))
    city_level: Mapped[str | None] = mapped_column(String(16))
    business_attribute: Mapped[str | None] = mapped_column(String(32))
    ...
    total_area: Mapped[float | None] = mapped_column(Numeric(10, 2))
    opening_date: Mapped[date | None] = mapped_column(Date)
    closing_date: Mapped[date | None] = mapped_column(Date)
    actual_open_date: Mapped[date | None] = mapped_column(Date)
    status: Mapped[str] = mapped_column(String(16), nullable=False, default="active", index=True)
    is_new_store: Mapped[int] = mapped_column(Integer, default=0)
    cooperation_mode: Mapped[str | None] = mapped_column(String(32))
    commercial_circle: Mapped[str | None] = mapped_column(String(128))
